...
export function ObserverForm({
  ...
  const groups = useMemo(() => groupItems(OBSERVER_ITEMS), []);
    ...
    <section className="cl-fade-in" key={step}>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-[#0A0A0A]">
          How does {subjectName} come across to you?
        </h1>
        <p className="mt-2 text-sm text-[#0A0A0A]/60">
          Answer honestly — {subjectName} only sees the overall pattern,
          never your individual answers.
        </p>
        <p className="mt-6 font-mono text-xs uppercase tracking-[0.14em] text-[#0A0A0A]/55">
        ...
        <h2 className="mt-6 text-xl font-semibold tracking-tight text-[#0A0A0A]">
